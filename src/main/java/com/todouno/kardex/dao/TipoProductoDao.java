...
public class TipoProductoDao {
	...
	public TipoProducto obtenerTipoProductoPorId(long idTipoProducto) {
		...
		SqlRowSet sqlRowSet = dataMgr.executeQuery(" SELECT * FROM TIPOPRODUCTO WHERE codigo = :codigo", map);
	...
	public String editarTipoProducto(TipoProducto tipoProducto) {
		...
		// Armar la sentencia de actualización debase de datos
		String query = "UPDATE TIPOPRODUCTO SET nombre = :nombre, descripcion = :descripcion WHERE codigo = :codigo";
