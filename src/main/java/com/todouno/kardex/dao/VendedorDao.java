...
public class VendedorDao {
  ...
  public Vendedor obtenerVendedorPorId(long idVendedor) {
    ...
    SqlRowSet sqlRowSet =
        dataMgr.executeQuery(" SELECT * FROM VENDEDOR WHERE codigo = :codigo", map);
  ...
  public String editarVendedor(Vendedor vendedor) {
    ...
    // Armar la sentencia de actualización debase de datos
    String query =
        "UPDATE VENDEDOR SET nombres = :nombres, telefono = :telefono,correo = :correo ,fechaNacimiento = :fechaNacimiento ,documento = :documento  WHERE codigo = :codigo";
