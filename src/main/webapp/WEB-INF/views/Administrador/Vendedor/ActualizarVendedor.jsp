					...
					<div class="page-header float-left">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li class="active"><a href="#"> Actualizar vendedor</a></li>
							</ol>
						</div>
					</div>
				</div>
                	...
                	<div class="col-md-12">                	
                    	...
                    	<div class="card">
                        	...
                        	<div class="card-body">
                        		...
                        		<!-- Formulario -->
                        		<form:form id="formActVendedor" action="editarVendedor" method="post" modelAttribute="vendedor">
                                	...
                                	<div class="form-group">
                                		...
                                		<form:input id="nombres" path="nombres" class="form-control" aria-invalid="false" required = "true" value="${vendedor.nombres}"/>
                                	</div> 

                            		<!-- Campo para digitar el documento -->
                                	<div class="form-group">
                                    	<label for="text-input" class=" form-control-label">Documento</label>
                                		<form:input id="documento" path="documento" class="form-control" aria-invalid="false" required = "true" value="${vendedor.documento}"/>
                                	</div> 
                                	
                            		<!-- Campo para digitar el telefono -->
                                	<div class="form-group">
                                    	<label for="text-input" class=" form-control-label">Teléfono</label>
                                		<form:input id="telefono" path="telefono" class="form-control" aria-invalid="false" required = "true" value="${vendedor.telefono}"/>
                                	</div> 
                                	
                            		<!-- Campo para digitar el correo -->
                                	<div class="form-group">
                                    	<label for="text-input" class=" form-control-label">Correo electrónico</label>
                                		<form:input id="correo" path="correo" class="form-control" aria-invalid="false" required = "true" value="${vendedor.correo}"/>
                                	</div> 
									...
									<div class="form-group">
										...
										<form:input type="date" id="fechaDeNacimiento" path="fechaDeNacimiento"
											class="form-control" aria-invalid="false" required="true" value="${vendedor.fechaDeNacimiento}" />
									</div>
