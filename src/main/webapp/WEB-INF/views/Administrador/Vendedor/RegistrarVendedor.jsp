					...
					<div class="page-header float-left">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li class="active"><a href="#"> Registrar vendedor</a></li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-header">
								<strong class="card-title">Registrar vendedor</strong>
							</div>
							<div class="card-body">
								...
								<!-- Formulario -->
								<form:form id="formVendedor" action="guardarVendedor"
									method="post" modelAttribute="vendedor" enctype="multipart/form-data">
