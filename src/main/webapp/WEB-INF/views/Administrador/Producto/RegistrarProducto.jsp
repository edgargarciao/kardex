					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-header">
								<strong class="card-title">Registrar producto</strong>
							</div>
							<div class="card-body">
								...
								<!-- Formulario -->
								<form:form id="formProducto" action="guardarProducto"
									method="post" modelAttribute="producto">

									<div class="form-group">
										<form:select path="tipoProducto.codigo" id="idTipoProducto"
											class="form-control">
											<form:option value="0" label="Seleccione el tipo de producto" />
									...
									<div class="form-group">
										...
										<form:input id="nombre" path="nombre" class="form-control"
											placeholder="Leche la mejor 500 ml, Harina Pan 1000 gr, entre otros"
											aria-invalid="false" required="true" />
									</div>
									<!-- Campo para digitar la cantidad -->
									<div class="form-group">
										<label for="text-input" class=" form-control-label">Precio</label>
										 <form:input path="precio" id="precio" class="form-control" type="number" min="0" step="1" required="true"/>
									</div>
									<!-- Campo para digitar la cantidad -->
									<div class="form-group">
										<label for="text-input" class=" form-control-label">Cantidad</label>
										 <form:input path="cantidad" id="cantidad" class="form-control" type="number" min="0" step="1" required="true"/>
									</div>
