					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="registrarProducto" class="btn btn-success">Registrar
									producto</a> <br> <br>
								...
								<table id="bootstrap-data-table"
									...
									<thead>
										<tr>
											<th scope="col" style="width: 25%">Tipo de producto</th>
									...
									<tbody>
										<c:forEach var="producto" items="${productos}">
											<tr>
												<td scope="row">${producto.tipoProducto.nombre}</td>	
												...
												<td><a
													...
													href="${contextPath}/eliminarProducto?id=${producto.codigo}">
